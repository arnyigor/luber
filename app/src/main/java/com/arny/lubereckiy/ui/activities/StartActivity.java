...
//				Local.viewObjectGenPlan(StartActivity.this, objects.get(position).getUrl());
			}
		});
	...
	private void setAdapterData(List<Pikobject> data) {
		Local.setAdapterData(adapter, data, recyclerView);
	}
